      ...
      >
        ...
        <div className="flex ">
          <Link href="/" className="-m-1.5 p-1.5">
            ...
            <span className="h-12 w-auto  text-white"> Booking.com</span>
          </Link>
        </div>
          ...
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                ...
                <div className="grid grid-cols-2 divide-x divide-gray-9--/5 bg-gray-50">
                  {callsToAction.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading text-[#013894] hover:bg-gray-100"
                    >
                      <item.icon
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013894] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className=" m-1.5 p-1.5">
                ...
                <span className="h-8 w-auto text-white">Booking.com</span>
              </a>
              <button
                type="button"
